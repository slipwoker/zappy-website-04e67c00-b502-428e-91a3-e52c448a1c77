document.addEventListener('DOMContentLoaded', function() {
  ...
  // Intersection Observer for better performance (progressive enhancement)
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאמי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '04e67c00-b502-428e-91a3-e52c448a1c77',
                    name: data.name || '',
                    email: data.email || '',
